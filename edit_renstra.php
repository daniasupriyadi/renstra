...
if(isset($_POST['update'])){
    $indikator_kinerja_id = $_POST['indikator_kinerja_id'];
    $tujuan = $_POST['tujuan'];
    ...
    $update_data = mysqli_query($mysql, 
...
$show_data = mysqli_query($mysql, 
    ...
    while($data = mysqli_fetch_array($show_data))
    {
        ...
        $indikator_kinerja_kegiatan = $data['indikator_kinerja_kegiatan'];
        $indikator_kinerja_sub_kegiatan = $data['indikator_kinerja_sub_kegiatan'];
        $indikator_kinerja_unit_kerja = $data['indikator_kinerja_unit_kerja'];
        $target = $data['target'];
        $satuan = $data['satuan'];
    }
?>
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="ml-3">Edit Data Rencana Strategis</h3>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="add_renstra.php" method="post" name="add_renstra">
                                <input type="text" name="tujuan" placeholder="Tujuan" value="<?php echo $tujuan; ?>"
                                    class="form-control">
                                <br>
                                <input type="text" name="sasaran_kegiatan" value="<?php echo $sasaran_kegiatan ?>"
                                    placeholder="Sasaran Kegiatan" class="form-control">
                                <br>
                                <input type="text" name="kode" value="<?php echo $kode ?>" placeholder="Kode"
                                    class="form-control">
                                <br>
                                <input type="text" name="unit_id" value="<?php echo $unit_id ?>" placeholder="PIC"
                                    class="form-control">
                                <br>
                                <input type="text" name="indikator_kinerja_kegiatan"
                                    value="<?php echo $indikator_kinerja_kegiatan ?>"
                                    placeholder="Indikator Kinerja Kegiatan" class="form-control">
                                <br>
                                <input type="text" name="indikator_kinerja_sub_kegiatan"
                                    value="<?php echo $indikator_kinerja_sub_kegiatan ?>"
                                    placeholder="Indikator Kinerja Sub Kegiatan" class="form-control">
                                <br>
                                <input type="text" name="indikator_kinerja_unit_kerja"
                                    value="<?php echo $indikator_kinerja_unit_kerja ?>"
                                    placeholder="Indikator Kinerja Unit Kerja" class="form-control">
                                <br>
                                <input type="text" name="target" value="<?php echo $target ?>" placeholder="Target"
                                    class="form-control">
                                <br>
                                <input type="text" name="satuan" value="<?php echo $satuan ?>" placeholder="Realisasi"
                                    class="form-control">
                                <br>
                                <div class="">
                                    <input type="hidden" name="indikator_kinerja_id"
                                        value=<?php echo $_GET['indikator_kinerja_id']; ?>>
